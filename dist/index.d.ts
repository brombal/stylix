 ...
 */
type StylixProps<TOverrideProps = unknown, TExtendsFromProps = unknown> = Extends<
  TExtendsFromProps,
  {
    /**
     * Additional styles.
...
declare function StylixProvider({
  id,
  devMode,
  plugins,
  media,
...
declare function StyleElement(
  props: {
    styles: string[];
  } & Partial<HTMLProps<'style'>>,
...
declare function useGlobalStyles(
  styles: StylixStyles,
  options?: {
    disabled?: boolean;
  },
 ...
 * ```
 */
declare function mapObject<TSource>(
  source: TSource,
...
type StylixRenderFn<TProps = any> = (
 ...
 */
type Stylix$Props<TComponent extends React.ElementType> =
...
declare function RenderServerStyles(
  props: Partial<HTMLProps<'style'>>,
): react_jsx_runtime.JSX.Element;
