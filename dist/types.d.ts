 ...
 * <$ $el={...}>...</$>
 */
export declare type Stylix$Props<TComponent extends HasProps> = {
    $el: TComponent;
    $elProps?: Partial<React.ComponentPropsWithoutRef<TComponent>>;
    children?: any;
} & Stylix$disabledProp & ComponentPropsWithoutCSS<TComponent> & StylixStyleProperties & Record<string, any>;
/**
 ...
 */
export declare type StylixProps<T extends HasProps = any> = Omit<Stylix$Props<T>, '$el'>;
/**
 * All standard CSS properties plus the $css prop.
 */
declare type StylixStyleProperties = Stylix$cssProp & {
 ...
 */
export declare type HasProps = keyof JSX.IntrinsicElements | JSXElementConstructor<any>;
/**
 * Any component's props without css properties (to avoid conflicts).
 */
declare type ComponentPropsWithoutCSS<TComponent extends HasProps> = Omit<React.ComponentPropsWithRef<TComponent>, keyof CSSProperties>;
/**
 * Additional properties on Stylix component functions.
 */
declare type StylixMetaProperties = {
    displayName?: string;
    __isStylix: true;
};
/**
...
export declare type Stylix$Component = {
    <TComponent extends HasProps>(props: Stylix$Props<TComponent>, context?: any): React.ReactElement<any, any> | null;
} & StylixMetaProperties & StylixHtmlTags;
/**
 * Type of Stylix html components ($.div, $.span, etc)
 */
export declare type StylixHtmlComponent<ElType extends React.ElementType> = React.FunctionComponent<StylixProps<ElType>> & StylixMetaProperties;
/**
